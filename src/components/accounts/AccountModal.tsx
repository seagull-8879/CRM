...
import { X, Building2, AlertTriangle, ShieldCheck, Check } from 'lucide-react';
...
export const AccountModal: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-xs">
      <div className="bg-[#121215] rounded-2xl border border-zinc-800 shadow-2xl max-w-3xl w-full overflow-hidden animate-in fade-in zoom-in-95 duration-150 max-h-[92vh] flex flex-col">
        {/* Header */}
        <div className="p-6 border-b border-zinc-800 flex items-center justify-between bg-[#161619] shrink-0">
        ...
        {/* Form Body */}
        <form onSubmit={handleSubmit} className="p-6 space-y-6 overflow-y-auto flex-1 text-xs text-zinc-300">
          {error && (
          ...
          {duplicateWarning && (
            <div className="p-3 bg-amber-500/10 border border-amber-500/20 rounded-xl text-amber-300 font-medium flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 bg-[#161619] border border-zinc-800 rounded-lg text-sm text-zinc-100 placeholder:text-zinc-600 focus:outline-hidden focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500"
                />
              </div>

              <div>
                <label className="block font-semibold text-zinc-300 mb-1">Account Owner *</label>
                <input
                  type="text"
                  readOnly
                  value={currentUser?.name || 'Janaki Pawar'}
                  className="w-full px-3 py-2 bg-zinc-900 border border-zinc-800 rounded-lg text-sm text-zinc-400 cursor-not-allowed"
                />
              </div>

              <div>
                <label className="block font-semibold text-zinc-300 mb-1">Account Type</label>
                <select
                  value={type}
                  onChange={(e) => setType(e.target.value as AccountType)}
                  className="w-full px-3 py-2 bg-[#161619] border border-zinc-800 rounded-lg text-sm text-zinc-100 focus:outline-hidden focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500"
                >
              ...
              <div>
                <label className="block font-semibold text-zinc-300 mb-1">Company Phone</label>
                <input
                  type="text"
                  value={phone}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 bg-[#161619] border border-zinc-800 rounded-lg text-sm font-semibold text-zinc-100 focus:outline-hidden focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500"
                />
              </div>

              <div>
                <label className="block font-semibold text-zinc-300 mb-1">Employee Count</label>
                <input
                  type="number"
                  min="1"
                  value={employees}
              ...
              <div>
                <label className="block font-semibold text-zinc-300 mb-1">Business Segment</label>
                <select
              ...
              <div>
                <label className="block font-semibold text-zinc-300 mb-1">Account Rating</label>
                <select
                  value={rating}
              ...
              <div>
                <label className="block font-semibold text-zinc-300 mb-1">Ownership</label>
                <select
                  value={ownership}
              ...
              <div>
                <label className="block font-semibold text-zinc-300 mb-1">Customer Status</label>
                <select
          ...
          <div className="pt-4 border-t border-zinc-800">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Billing */}
              <div className="space-y-2.5 p-3.5 bg-[#161619] border border-zinc-800 rounded-xl">
                <div className="font-bold text-zinc-100 text-xs">Billing Address</div>
                <div>
                  <label className="block text-[11px] text-zinc-400 mb-0.5">Street Address</label>
                  <input
                    type="text"
                    value={billingStreet}
                    onChange={(e) => setBillingStreet(e.target.value)}
                    placeholder="100 Main St, Suite 400"
                    className="w-full px-2.5 py-1.5 bg-[#121215] border border-zinc-800 rounded-md text-xs text-zinc-100 placeholder:text-zinc-600 focus:outline-hidden focus:border-blue-500"
                  />
                </div>
                <div className="grid grid-cols-2 gap-2">
                  <div>
                    <label className="block text-[11px] text-zinc-400 mb-0.5">City</label>
                    <input
                      type="text"
                      value={billingCity}
                  ...
                  <div>
                    <label className="block text-[11px] text-zinc-400 mb-0.5">State / Province</label>
                    <input
                      type="text"
                      value={billingState}
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div>
                    <label className="block text-[11px] text-zinc-400 mb-0.5">Postal Code</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-[11px] text-zinc-400 mb-0.5">Country</label>
                    <input
                      type="text"
              ...
              <div className="space-y-2.5 p-3.5 bg-[#161619] border border-zinc-800 rounded-xl">
                <div className="flex items-center justify-between">
                  <div className="font-bold text-zinc-100 text-xs">Shipping Address</div>
                ...
                {!sameAsBilling && (
                  <>
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      ...
                      <div>
                        <label className="block text-[11px] text-zinc-400 mb-0.5">State</label>
                        <input
                          type="text"
                          value={shippingState}
